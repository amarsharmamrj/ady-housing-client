...
const FilterContent = ({ selectedFilters, setSelectedFilters, filters, priceValue, handlePriceChange, formatSelectedDisplayValue, handleDelete, handleValueSelected }) => {
    return (
        <>
